    ...
    if (isEditing && projectData) {
      form.reset({
        ...
        invoicingContact: projectData.invoicingContact ? {
          personType: (projectData.invoicingContact.personType as any) || 'LEGAL',
          name: projectData.invoicingContact.name || "",
          document: projectData.invoicingContact.document || "",
          email: projectData.invoicingContact.email || "",
          phone: projectData.invoicingContact.phone || "",
          cep: projectData.invoicingContact.cep || "",
          street: projectData.invoicingContact.street || "",
          number: projectData.invoicingContact.number || "",
          complement: projectData.invoicingContact.complement || "",
          neighborhood: projectData.invoicingContact.neighborhood || "",
          city: projectData.invoicingContact.city || "",
          state: projectData.invoicingContact.state || "",
        } : {
          personType: 'LEGAL',
          name: "",
          document: "",
