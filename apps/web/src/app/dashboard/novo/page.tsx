  ...
  useEffect(() => {
    if (isEditing && projectData) {
      form.reset({
        ...
        status: (projectData.status as any) || "PLANNING",
        ...
        projectContacts: (projectData as any).projectContacts || [],
        hasInvoicingData: !!projectData.invoicingContactId,
        invoicingContact: (projectData as any).invoicingContact ? {
          personType: ((projectData as any).invoicingContact.personType as any) || 'LEGAL',
          name: (projectData as any).invoicingContact.name || "",
          document: (projectData as any).invoicingContact.document || "",
          email: (projectData as any).invoicingContact.email || "",
          phone: (projectData as any).invoicingContact.phone || "",
          cep: (projectData as any).invoicingContact.cep || "",
          street: (projectData as any).invoicingContact.street || "",
          number: (projectData as any).invoicingContact.number || "",
          complement: (projectData as any).invoicingContact.complement || "",
          neighborhood: (projectData as any).invoicingContact.neighborhood || "",
          city: (projectData as any).invoicingContact.city || "",
          state: (projectData as any).invoicingContact.state || "",
        } : {
          personType: 'LEGAL',
          name: "",
          document: "",
